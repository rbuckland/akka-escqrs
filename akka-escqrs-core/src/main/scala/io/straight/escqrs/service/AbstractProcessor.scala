...
import io.straight.escqrs.model.validation.simple._
 ...
 * @author rbuckland
 */
trait AbstractProcessor[D <: DomainType[I], VD <: AnyRef, VE <: AnyRef, E <: EventType, C <: CommandType, I <: Any] extends PersistentActor with ActorLogging {
  ...
  /**
   * We will call this method once recovery has completed
   */
  def onRecoveryComplete = {}
